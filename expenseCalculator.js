        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
               ...
               {
                 tax = 18550 * 0.10 + (income - 18550) * .15;
                 taxRate=15;
               }
          ...
          *******************************************************************************/
                ...
                {
                    tax = 9275 * .10 + (income - 9275) * .15;
                    taxRate = 15;
                }
                else if(income <= 75950)
                {
                    tax= 9275 * .10 + (37650 - 9275) * .15 + (income -37650) * .25;
                    taxRate = 25;
                }
                else if(income <= 115725)
                {
                    tax= 9275 * .10 + (37650 - 9275) * .15 + (75950 - 37650) * .25 + (income - 75950) * .28;
                    taxRate = 28;
                }
                else if(income <= 206675)
                {
                    tax = 9275 * .10 + (37650 - 9275) * .15 + (75950 - 37650) * .25 + (115725 - 75950) * .28 + (income - 115725) * .33;
                    taxRate = 33;
                }
                else if(income <= 233475)
                {
                    tax = 9275 * .10 + (37650 - 9275) * .15 + (75950 - 37650) * .25 + (115725 - 75950) * .28 + (206675 - 115725) * .33 + (income -206675) * .35;
                    taxRate = 35;
                }
                else 
                {
                    tax = 9275 * .10 + (37650 - 9275) * .15 + (75950 - 37650) * .25 + (115725 - 75950) * .28 + (206675 - 115725) * .33 + (233475 -206675) * .35 + (income - 233475) * .396;
                    taxRate = 39.6;
                }
          ...
          *******************************************************************************/
                ...
                {
                    tax = 13250 * .10 + (income - 13250) * .15;
                    taxRate = 15;
                }
                else if(income <= 130150)
                {
                    tax = 13250 * .10 + (50400 - 13250) * .15+ (income - 50400) * .25;
                    taxRate = 25;
                }
                else if (income <= 210800)
                {
                    tax = 13250 * .10 + (50400 - 13250) * .15+ (130150 - 50400) * .25 + (income -130150) * .28;
                    taxRate = 28;
                }
                else if (income <= 413350)
                {
                     tax = 13250 * .10 + (50400 - 13250) * .15+ (130150 - 50400) * .25 + (210800 -130150) * .28 + (income - 210800) * .33;
                    taxRate = 33;
                }
                else if (income <= 441000)
                {
                    tax = 13250 * .10 + (50400 - 13250) * .15+ (130150 - 50400) * .25 + (210800 -130150) * .28 + (413350 - 210800) * .33 + (income - 413350) * .35;
                    taxRate = 35;
                }
                else 
                {
                    tax = 13250 * .10 + (50400 - 13250) * .15+ (130150 - 50400) * .25 + (210800 -130150) * .28 + (413350 - 210800) * .33 + (441000 - 413350) * .35 + (income - 441000) * .396;
                    taxRate = 39.6;
                }
...
function clearButton () {
              ...
              //this code clears tax and tax bracket
