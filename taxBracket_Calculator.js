        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
               ...
               {
                 tax = 19050 * 0.10 + (income - 19050) * .12;
                 taxRate=12;
               }
               else if (income <= 165000) {
                 tax = 19050 * 0.10 + (77400 - 19050) * .12 +(income-77400) * .22;
                 taxRate = 22;
               } //end of else if
               else if (income <= 315000) {
                 tax = 19050 * 0.10 + (77400 - 19050) * .12 +(165000-77400) * .22 + (income -165000) *.24;
                 taxRate = 24;
               }//end of else if
               else if (income <= 400000) {
                tax = 19050 * 0.10 + (77400 - 19050) * .12 +(165000-77400) * .22 + (315000 -165000) *.24 + (income -315000) *.32;
                 taxRate = 32;
               }//end of else if
               else if (income <= 600000) {
                  tax = 19050 * 0.10 + (77400 - 19050) * .12 +(165000-77400) * .22 + (315000 -165000) *.24 + (400000 -315000) *.32 + (income -400000)*.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 19050 * 0.10 + (77400 - 19050) * .12 +(165000-77400) * .22 + (315000 -165000) *.24 + (400000 -315000) *.32 + (600000 -400000)*.35 + (income - 600000) *.37;
                  taxRate = 37;
               }//end of nested if
